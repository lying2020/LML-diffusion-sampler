...
class XTNoiseAnalysis:
    ...
    def plot_eigenvalue_analysis(self, pure_noise_eigenvalues, xT_eigenvalues, save_dir='./zigzag_cg_hessian'):
        """绘制特征值分析图"""
    ...
    def generate_analysis_report(self, pure_noise_pca, xT_pca, pure_noise_eigenvalues, xT_eigenvalues, save_dir='./zigzag_cg_hessian'):
        """生成分析报告"""
        os.makedirs(save_dir, exist_ok=True)
