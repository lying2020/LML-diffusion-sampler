...
class XTNoiseDeepAnalysis:
    ...
    def plot_analysis_results(self, sample_size_results, multiple_runs_results, eigenvalues, save_dir=os.path.join(project.output_dir, 'zigzag_cg_hessian')):
        """绘制分析结果"""
    ...
    def generate_deep_analysis_report(self, sample_size_results, multiple_runs_results, eigenvalues, save_dir=os.path.join(project.output_dir, 'zigzag_cg_hessian')):
        """生成深度分析报告"""
        os.makedirs(save_dir, exist_ok=True)
