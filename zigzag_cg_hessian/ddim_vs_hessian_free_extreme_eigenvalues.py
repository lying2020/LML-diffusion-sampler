...
class ExtremeEigenvaluesAnalyzer:
    ...
    def plot_extreme_eigenvalues_comparison(self, results_dict, eigenvalues, save_dir='./zigzag_cg_hessian'):
    ...
    def generate_extreme_eigenvalues_report(self, results_dict, eigenvalues, save_dir='./zigzag_cg_hessian'):
