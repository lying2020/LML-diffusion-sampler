...
class DDPMvsHessianFreeAnalyzer:
    ...
    def plot_ddpm_vs_hessian_free(self, results_dict, save_dir='./zigzag_cg_hessian'):
    ...
    def generate_angle_analysis_report(self, results_dict, save_dir='./zigzag_cg_hessian'):
