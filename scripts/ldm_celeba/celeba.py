...
def parse_args():
    ...
    parser.add_argument('--grid_test_num', type=int, default=14, help='Number of images to test in grid')
    # parser.add_argument('--grid_test_index', type=list, default=[0, 1, 2, 3, 4, 5], help='Index of images to test in grid')
    parser.add_argument('--grid_test_index', type=list, default=[3, 13, 17, 18, 23, 28, 31, 50, 70, 73, 75, 77, 83], help='Index of images to test in grid')
