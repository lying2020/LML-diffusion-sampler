...
def parse_args():
    ...
    parser.add_argument('--save_dir', type=str, default='celebahq_256_new')
    ...
    parser.add_argument('--unuse_lanczos_estimation', type=bool, default=False, help='Skip Lanczos estimation, use fixed eigenvalues for fast testing (default: False)')
    ...
    parser.add_argument('--fixed_beta', type=float, default=0.001, help='Fixed beta_t when unuse_lanczos_estimation=True (default: 0.001)')
    ...
    parser.add_argument('--lambda_base', type=float, default=0.0, help='Base lambda_t (default: 0.3, optimized). If use_adaptive_lambda=False, use fixed lambda_t = lambda_base.')
    ...
    parser.add_argument('--eigenvalue_cache_interval', type=int, default=1, help='Re-estimate eigenvalues every N steps when caching is enabled (default: 5). If use_adaptive_lambda=True, re-estimate eigenvalues every N steps when caching is enabled.')
