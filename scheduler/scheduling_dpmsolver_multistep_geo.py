...
class DPMSolverMultistepSchedulerGeo(SchedulerMixin, ConfigMixin):
    """
    `DPMSolverMultistepSchedulerGeo` is a fast dedicated high-order solver for diffusion ODEs.
        ...
        if self.config.algorithm_type in ["dpmsolver++", "sde-dpmsolver++"]:
            if self.config.prediction_type == "epsilon":
                ...
                raise ValueError(
                    ...
                    "`v_prediction`, or `flow_prediction` for the DPMSolverMultistepSchedulerGeo."
                )
        ...
        # DPM-Solver needs to solve an integral of the noise prediction model.
            ...
            if self.config.prediction_type == "epsilon":
                ...
                raise ValueError(
                    ...
                    " `v_prediction` for the DPMSolverMultistepSchedulerGeo."
                )
